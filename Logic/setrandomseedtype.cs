...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U4KRJPX98/F7VEA0AG5/setrandomseedtype.cs?nojsmode=1" /></noscript>
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>setRandomSeedType.cs | Playmaker Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/155191149137?crumb=s-1523196707-5bb2ee3d805d8ccad62ef5840ff3451e24152f44cb6f4f0e6150bfc52333eef0-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	...
	Created by tcmeric on Monday, November 6, 2017 at 10:01 AM
	</strong><br />
	<span class="subtle_silver break_word">https://playmakertalk.slack.com/files/U4KRJPX98/F7VEA0AG5/setrandomseedtype.cs</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T4K5M4D41-F7VEA0AG5-6c3d6c513f" target="new">https://slack-files.com/T4K5M4D41-F7VEA0AG5-6c3d6c513f</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		1KB C# snippet created on <span class="date">November 6, 2017</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">// (c) Copyright HutongGames, LLC 2010-2017. All rights reserved.
...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip(&quot;Change random seed settings for unity.&quot;)]

	public class setRandomSeedType : FsmStateAction

	{
		public FsmInt setManualSeed;
		public FsmBool setToMilisecond;
		public FsmBool setToTicks;
		public FsmBool debugSeed;

		public override void Reset()
		{
			
			debugSeed = false;
			setToMilisecond = null;
			setToTicks = false;
			setManualSeed = new FsmInt { UseVariable = true};
		...
		void setSeed()
		{
			...
			if(!setManualSeed.IsNone)
			{
				Random.seed = setManualSeed.Value;	
				if(debugSeed.Value){Debug.Log(&quot;Current Seed is &quot; + Random.seed);}
			}
			
			if (setToMilisecond.Value)
			{
...
<div class="loading_hash_animation">
	...
	<form action="https://playmakertalk.slack.com/files/U4KRJPX98/F7VEA0AG5/setrandomseedtype.cs"
		...
		<input type="hidden" name="crumb" value="s-1523196707-9e473a74ed23d7d3e74464229ef50ea99af62a0475ed7460e6282a6663273ed9-☃" />
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.5afece10ceabb3d91968.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F7VEA0AG5","created":1509933665,"timestamp":1509933665,"name":"setRandomSeedType.cs","title":"setRandomSeedType.cs","mimetype":"text\/plain","filetype":"csharp","pretty_type":"C#","user":"U4KRJPX98","editable":true,"size":1314,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T4K5M4D41-F7VEA0AG5\/setrandomseedtype.cs","url_private_download":"https:\/\/files.slack.com\/files-pri\/T4K5M4D41-F7VEA0AG5\/download\/setrandomseedtype.cs","permalink":"https:\/\/playmakertalk.slack.com\/files\/U4KRJPX98\/F7VEA0AG5\/setrandomseedtype.cs","permalink_public":"https:\/\/slack-files.com\/T4K5M4D41-F7VEA0AG5-6c3d6c513f","edit_link":"https:\/\/playmakertalk.slack.com\/files\/U4KRJPX98\/F7VEA0AG5\/setrandomseedtype.cs\/edit","preview":"\/\/ (c) Copyright HutongGames, LLC 2010-2017. All rights reserved.\r\n\r\nusing UnityEngine;\r\n\r\nnamespace HutongGames.PlayMaker.Actions\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E\/\/ (c) Copyright HutongGames, LLC 2010-2017. All rights reserved.\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eusing\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003EUnityEngine\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Enamespace\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003EHutongGames\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EPlayMaker\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EActions\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":67,"lines_more":62,"preview_is_truncated":true,"channels":["C4KU5EU3F"],"groups":[],"ims":[],"comments_count":1,"reactions":[{"name":"+1","users":["U4SSVL83V","U9SA45Q76"],"count":2}]};
		boot_data.file.comments = [{"id":"FcA45SR11D","created":1523195064,"timestamp":1523195064,"user":"U4KRJPX98","is_intro":false,"comment":"1"}];
...
<!-- slack-www-hhvm-07c35df2dbef07d1a / 2018-04-08 07:11:47 / v1080460bbd9e2157c4f3eac8edfc2e3e336cc20b / B:H -->
